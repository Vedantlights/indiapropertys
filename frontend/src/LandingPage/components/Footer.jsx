        ...
        <div className="footer-main">
          ...
          <div className="footer-column footer-about">
            <div className="footer-logo">
              <img src="/Media/logo.png" alt="India Propertys" className="footer-logo-image" />
            ...
            <ul className="footer-contact">
              <li>
                ...
                <div className="contact-text">
                  ...
                  <span className="contact-value">info@indiapropertys.com</span>
                </div>
              </li>
              <li>
                <div className="contact-icon">
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="footer-copyright">
              © {currentYear} <span className="copyright-brand">IndiaPropertys</span>. All rights reserved.
            </p>
          </div>
        </div>
      </div>
