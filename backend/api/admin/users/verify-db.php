...
try {
    ...
    // Test the exact query we use in list.php
    $testQuery = "SELECT id, full_name, email, phone, user_type, email_verified, phone_verified, profile_image, is_banned, created_at FROM users LIMIT 1";
    try {
