...
const SellerProfile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    gstNumber: '',
    reraNumber: '',
    bio: 'Experienced real estate professional with 10+ years in Mumbai property market. Specializing in luxury apartments and commercial properties.',
        ...
        <div className="seller-profile-card">
          ...
          <div className="seller-seller-profile-avatar-img-section">
            <div className="seller-seller-profile-avatar-img-wrapper">
              ...
              />
              <button className="seller-profile-avatar-seller-profile-edit-btn">
            ...
            <p className="seller-profile-role">{formData.agencyName}</p>
