...
const SellerOverview = ({ onNavigate }) => {
  const { properties, inquiries, getStats } = useProperty();
      ...
      <div className="seller-overview-stats-grid">
        <div className="seller-overview-stat-card seller-overview-stat-primary">
          ...
          <div className="seller-overview-stat-content">
            <span className="seller-overview-stat-label">Total Properties</span>
            <div className="seller-overview-stat-value-row">
              <span className="seller-overview-stat-value">{stats.totalProperties}</span>
              <span className="seller-overview-stat-badge seller-overview-badge-success">Active</span>
            </div>
          </div>
        </div>
        ...
        <div className="seller-overview-stat-card">
          ...
          <div className="seller-overview-stat-content">
            <span className="seller-overview-stat-label">Total Views</span>
            <div className="seller-overview-stat-value-row">
