      ...
      <div className="navbar-container">
        <div className="navbar-content">
          ...
          <Link to="/" className="navbar-logo">
            <div className="logo-container">
              <img src="/Media/logo.png" alt="India Propertys" className="logo-image" />
            </div>
          </Link>

          {/* Desktop Navigation Links */}
          <div className="nav-links-desktop">
            <Link to="/LandingHome" className={`nav-link ${isActive('/LandingHome') ? 'active' : ''}`}>
              <span>Home</span>
            </Link>
        ...
        <div className={`mobile-menu ${isMenuOpen ? 'open' : ''}`}>
          <div className="mobile-menu-content">
            <Link to="/LandingHome" className={`mobile-nav-link ${isActive('/LandingHome') ? 'active' : ''}`}>
              <span>Home</span>
            </Link>
